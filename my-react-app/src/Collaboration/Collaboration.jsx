...
function Collaboration() {
    ...
    return (
        <section className='w-full p-3 flex flex-col md:items-start justify-center items-center bg-[#0e0d15] '>
            <h2 className='text-white text-2xl font-bold my-10'>AI Chat App for seamless collaboration</h2>
            {

                collabContent.map((data) => (
                    <div key={data.id} className='text-white mb-4 md:w-[40%] w-full'>
