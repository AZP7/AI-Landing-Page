    ...
    >
    
      {
        data&&data.map((benefit) => (
          <div key={benefit.id} 
            className='relative transition-all duration-500 ease-in overflow-hidden w-[95vw] h-[50vh] sm:w-[75vw] md:w-[45vw]
             md:h-[350px] lg:w-[30vw] lg:h-[300px] xl:w-[25vw]  my-3 p-4 flex flex-col justify-around items-start bg-no-repeat
             bg-[length:100%_100%] rounded-xl shadow-lg'
