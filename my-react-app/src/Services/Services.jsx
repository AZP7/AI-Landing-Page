...
function Services() {
  return (
    ...
    >
      ...
      <div className='w-[90%] lg:flex-row flex flex-col lg:justify-between lg:items-center'>
        <div className='w-full lg:w-[48%] lg:h-[550px]  border h-[85vh] rounded-2xl my-7 border-[grey] flex flex-col justify-around items-end '
        ...
        <div className='border lg:w-[48%] lg:h-[550px] border-[#343434] bg-[#1a19196e] w-full h-[650px] rounded-2xl  flex flex-col justify-around items-center p-1    '>
          ...
          >
            <img src={bg3} className='absolute bg-[#0c0b0b] rounded-2xl top-0 object-cover z-0 left-0 w-full h-full' alt="" />
