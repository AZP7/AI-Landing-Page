    ...
    <>
      ...
      >
        ...
        <div className='w-full flex justify-center'>
          ...
          <div className='w-[90%] bg-grey/20 backdrop-blur-md   border border-[grey] flex p-4 rounded-4xl text-white items-center justify-start'>
              ...
              <div className='flex w-full  justify-around '>
                  {
                    brainwaveServicesIcons.map((data,index)=>(
                      <img key={index} src={data} className='w-[50px] p-2 border rounded-2xl bg-[grey]/30 backdrop-blur-2xl ' />
                    ))
                  }
              </div>
          </div>
